            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="f-18">Product Chat Details</div>
                        <div>
                                ...
                                <div id="chat_details" class="card p-2">
                                    @if (count($conversations) > 0)
                                        ...
                                        {{-- <div class="text-center p-3 my-2 background_primary_bg text-light">
                                            @php
                                            @endphp
                                            <div>Conversation {{ $loop->index + 1 }}, <span>Date: {{_date_format($conversation->created_at)}} </span></div>
                                        </div> --}}
                                                    ...
                                                    <div class="d-flex ms-auto">
                                                        <div class="flex-grow-1 me-2">
                                                            <p class="mb-0 chat-time text-end">
                                                                @if (count($conversation->questions->attachment) > 0)
                                                                    @foreach ($conversation->questions->attachment as $attachment)
                                                                        @php
