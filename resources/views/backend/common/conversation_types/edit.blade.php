            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb d-flex justify-content-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Conversation types</li>
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route(\Request::segment(1) . '.conversation_types') }}">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="post" action="{{ route(\Request::segment(1) . '.conversation_types.update', $model->id) }}">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-12 col-md-12">
                                        ...
                                        @else
                                            <div class="mt-1">Conversation type name required</div>
                                        @endif
                                    </div>
                                </div>
