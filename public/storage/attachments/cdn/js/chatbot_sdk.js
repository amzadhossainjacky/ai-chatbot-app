...
// var commonTicketUrl = "https://ticket.bswnbr.gov.bd/";
//var commonTicketUrl = "https://172.18.49.230/";
const commonTicketBearerToken = "iHelp_Web_Fontainer@2025";
// Use local proxy route to avoid CORS issues. Backend will forward to the AI server.
var aiApiUrl = "http://114.130.69.239:5021/ask";
...
function create_chatbot_card_layout_ar() {
    ...
    /*&&&&&&&&&&&&&&&&&&&& 1.2.4 tab_ai_kb_ar wrapper container start &&&&&&&&&&&&&&&&&&&&*/
    let tab_ai_kb_ar = document.createElement("div");
    tab_ai_kb_ar.classList.add("tab_content_ar");
    tab_ai_kb_ar.id = "tab_ai_kb_ar";
    ...
    chatbot_body_wrapper_ar.appendChild(tab_ai_kb_ar);
    ...
    /*#########################################################################################           
        1.7 ai_knowledge_footer_ar wrapper container start         
    #########################################################################################*/
    let ai_knowledge_footer_ar = document.createElement("form");
    ai_knowledge_footer_ar.classList.add("chatbot_footer_ar");
    ai_knowledge_footer_ar.id = "ai_knowledge_footer_ar";

    /*==================== 1.7.1 ai_knowledge_footer_ar main container   ====================*/
    let ai_chat_with_agent_wrapper_ar = document.createElement("div");
    ai_chat_with_agent_wrapper_ar.classList.add("chat_with_agent_wrapper_ar");

    /*==================== 1.7.2 ai_knowledge_footer_ar chat div section  ====================*/
    let ai_chat_with_agent_div_ar = document.createElement("div");
    ai_chat_with_agent_div_ar.classList.add("chat_with_agent_div_ar");
    ai_chat_with_agent_div_ar.id = "ai_chat_div_ar";

    /*==================== 1.7.3 ai_knowledge_footer_ar live chat footer section  ====================*/
    let ai_chat_footer_ar = document.createElement("div");
    ai_chat_footer_ar.classList.add("live_chat_footer_ar");

    /* ai_knowledge_footer_ar textarea input */
    let ai_chat_input_ar = document.createElement("textarea");
    ai_chat_input_ar.classList.add("input_like_textarea_ar");
    ai_chat_input_ar.id = "ai_input_like_textarea_ar";
    ai_chat_input_ar.name = "ai_question";
    ai_chat_input_ar.setAttribute("placeholder", "Type your message...");

    /* ai_knowledge_footer_ar submit button */
    let submit_ai_chat_ar = document.createElement("button");
    submit_ai_chat_ar.id = "submit_ai_chat_ar";
    submit_ai_chat_ar.classList.add("submit_button_ar");

    /* submit button icon */
    let submit_ai_chat_icon_ar = document.createElement("i");
    submit_ai_chat_icon_ar.classList.add("fa-solid", "fa-paper-plane");

    /* append icon to submit button */
    submit_ai_chat_ar.appendChild(submit_ai_chat_icon_ar);

    /* append textarea and submit button to live chat footer */
    ai_chat_footer_ar.appendChild(ai_chat_input_ar);
    ai_chat_footer_ar.appendChild(submit_ai_chat_ar);

    /* append live chat footer to chat div */
    ai_chat_with_agent_div_ar.appendChild(ai_chat_footer_ar);

    /* append chat div to wrapper */
    ai_chat_with_agent_wrapper_ar.appendChild(ai_chat_with_agent_div_ar);

    /*==================== 1.7.4 ai_knowledge_footer_ar watermark section    ====================*/
    // let ai_knowledge_watermark_ar = document.createElement("p");
    // ai_knowledge_watermark_ar.classList.add("watermark_ar");
    // ai_knowledge_watermark_ar.setAttribute("data-i18n", "powered_by");
    // ai_knowledge_watermark_ar.innerText = "Powered by iHelpBD";

    /*==================== 1.7.5 append all sections to ai_knowledge_footer_ar   ====================*/
    ai_knowledge_footer_ar.appendChild(ai_chat_with_agent_wrapper_ar);
    // ai_knowledge_footer_ar.appendChild(ai_knowledge_watermark_ar);

    /* append ai_knowledge_footer_ar to chatbot layout */
    chatbot_layout_ar.appendChild(ai_knowledge_footer_ar);
    ...
    /*==================== 1.7.4 AI knowledge tab section    ====================*/
    let ai_kb_tab_ar = document.createElement("div");
    ai_kb_tab_ar.classList.add("tab_ar");
    ai_kb_tab_ar.setAttribute("data-tab", "ai_kb_ar");

    /* AI knowledge tab icon */
    let ai_kb_icon_ar = document.createElement("i");
    ai_kb_icon_ar.classList.add("fa-solid", "fa-book");

    /* AI knowledge tab text */
    let ai_kb_text_ar = document.createElement("span");
    ai_kb_text_ar.setAttribute("data-i18n", "ai_knowledge");
    ai_kb_text_ar.innerText = "AI Knowledge";

    /* append icon and text to AI knowledge tab */
    ai_kb_tab_ar.appendChild(ai_kb_icon_ar);
    ai_kb_tab_ar.appendChild(ai_kb_text_ar);

    /*==================== 1.7.5 append all tabs to chatbot_tabs_ar   ====================*/
    chatbot_tabs_ar.appendChild(tickets_tab_ar);
    chatbot_tabs_ar.appendChild(chat_tab_ar);
    chatbot_tabs_ar.appendChild(kb_tab_ar);
    chatbot_tabs_ar.appendChild(ai_kb_tab_ar);
   ...
   =============================== */
    const translations = {
        ...
        bn: {
            ...
            ai_knowledge_base: "AI জ্ঞানভাণ্ডার",
        },
    };
    ...
    function updateHeaderTitle() {
        ...
        switch (target) {
            ...
            case "ai_kb_ar":
                headerTitle.innerText = translations[lang].ai_knowledge_base;
                break;
        }
    }
    ...
    chatBtn.addEventListener("click", () => {
        ...
        // ← ADD THIS: reload history on every open
        //reloadChatHistory();

        // Re-establish Echo listener if a live chat session exists
        let storedToken = localStorage.getItem("token");
        let storedType = localStorage.getItem("conversation_type");
        if (storedToken && storedType === "Live-Chat") {
            chatbot_echo_listener(storedToken);
        }
    });
    ...
    const ai_knowledge_footer = document.getElementById(
        "ai_knowledge_footer_ar"
    );
        ...
        showLoader(() => {
            ...
            switch (target) {
                case "tickets_ar":
                    ...
                    ai_knowledge_footer.style.display = "none";
                ...
                case "ai_kb_ar":
                    headerTitle.innerText =
                        translations[lang].ai_knowledge_base;
                    ticket_footer_ar.style.display = "none";
                    chat_footer.style.display = "none";
                    //product_footer.style.display = "none";
                    knowledge_footer.style.display = "none";
                    ai_knowledge_footer.style.display = "block";
                    direct_chat_footer.style.display = "none";
                    phone_number_log_ar.style.display = "none";
                    liveChat.style.display = "none";

                    let tab_ai_kb_ar = document.getElementById("tab_ai_kb_ar");
                    tab_ai_kb_ar.innerHTML = "";
    ...
    document.querySelectorAll("#report_custom_select_ar").forEach((select) => {
        ...
        const dropdown = select.querySelector(".dropdown_ar");
        const search = select.querySelector(".search_input_ar");
        const optionsList = select.querySelector(".options_ar"); // the <ul>
        const selectedValue = select.querySelector(".selected_value_ar");
        const report_select_value_ar = document.getElementById(
            "report_select_value_ar"
        );
        ...
        // ✅ Delegate to the <ul> instead of individual <li> items
        optionsList.addEventListener("click", (e) => {
            ...
            optionsList
                .querySelectorAll("li")
                .forEach((o) => o.classList.remove("active_ar"));
            option.classList.add("active_ar");
            dropdown.style.display = "none";
            report_select_value_ar.dataset.id = option.getAttribute("value");
        });
    ...
    document.querySelectorAll("#bsw_custom_select_ar").forEach((select) => {
        ...
        const multi_dropdown = select.querySelector(".multi_dropdown_ar");
        ...
        // ✅ Event delegation — works even after fetch populates the <li> items
        optionsList.addEventListener("click", (e) => {
            const option = e.target.closest("li");
            if (!option) return;
            selectedValue.textContent = option.textContent;
            ...
            option.classList.add("active_ar");
            dropdown.style.display = "none";
            bsw_selected_value_ar.dataset.id = option.getAttribute("value");
        });
    ...
    document.querySelectorAll("#issue_custom_select_ar").forEach((select) => {
        ...
        const dropdown = select.querySelector(".dropdown_ar");
        const search = select.querySelector(".search_input_ar");
        const optionsList = select.querySelector(".options_ar"); // live <ul>
        const selectedValue = select.querySelector(".selected_value_ar");
        const issue_select_value_ar = document.getElementById(
            "issue_select_value_ar"
        );
        ...
        // ✅ Event delegation — works after fetch populates <li> items
        optionsList.addEventListener("click", (e) => {
            const option = e.target.closest("li");
            if (!option) return;
            selectedValue.textContent = option.textContent;
            ...
            option.classList.add("active_ar");
            dropdown.style.display = "none";
            issue_select_value_ar.dataset.id = option.getAttribute("value");
        });
    ...
    const ai_knowledge_footer_ar = document.getElementById(
        "ai_knowledge_footer_ar"
    );
    ...
    ai_knowledge_footer.addEventListener("submit", function (e) {
        e.preventDefault();
        let question = e.target.elements.ai_input_like_textarea_ar.value;
        let ai_knowledge_messages_ar = document.getElementById(
            "ai_knowledge_messages_ar"
        );
        let tab_ai_kb_ar = document.getElementById("tab_ai_kb_ar");
        let ai_input_like_textarea_ar = document.getElementById("ai_input_like_textarea_ar");   
        ...
        let htmlQuestionString =
            ...
            "</span>" +
            "</div>";
        tab_ai_kb_ar.insertAdjacentHTML("beforeend", htmlQuestionString);
        ...
        ai_input_like_textarea_ar.value = "";
        ...
        fetch(aiApiUrl, {
            ...
            .then((data) => {
                ...
                var htmlReplyString =
                            '<div class="agent_msg_ar">' +
                            '<span class="agentname_ar">Ai Agent</span>' +
                            '<div class="chat_message_ar bot_ar">' +
                            data.data.response +
                            "</div>" +
                            '<span class="reply_time_live_chat_agent_ar">' +
                            ...
                            "</span>" +
                            "</div>";
                        tab_ai_kb_ar.insertAdjacentHTML(
                            "beforeend",
                            htmlReplyString
                        );
            })
...
function agency_custom_select_ar_by_bsw() {
    document.querySelectorAll("#agency_custom_select_ar").forEach((select) => {
        ...
        // Clone display — removes stacked click listeners
        const oldDisplay = select.querySelector(".select_display_ar");
        const newDisplay = oldDisplay.cloneNode(true);
        oldDisplay.parentNode.replaceChild(newDisplay, oldDisplay);
        // ✅ Get selectedValue from newDisplay, NOT from detached oldDisplay
        const selectedValue = newDisplay.querySelector(".selected_value_ar");

        // Clone dropdown (contains search + optionsList) — removes stacked listeners
        const oldDropdown = select.querySelector(".dropdown_ar");
        const newDropdown = oldDropdown.cloneNode(true); // preserves <li> children
        oldDropdown.parentNode.replaceChild(newDropdown, oldDropdown);
        const newSearch = newDropdown.querySelector(".search_input_ar");
        const newOptionsList = newDropdown.querySelector(".options_ar");
        ...
        newOptionsList.addEventListener("click", (e) => {
            const option = e.target.closest("li");
            if (!option) return;
            selectedValue.textContent = option.textContent;
            newOptionsList
            ...
            const agencyId = option.getAttribute("value");
            agency_selected_value_ar.dataset.id = agencyId;

            let new_agency_selected_value_ar = document.getElementById(
                "agency_selected_value_ar"
            );
            new_agency_selected_value_ar.dataset.id = agencyId;

            // Fetch CLP types for the selected agency
            const clpUrl =
                commonTicketUrl +
            ...
            fetch(clpUrl, {
                ...
                .catch((error) => {
                    console.error("Error fetching CLP types:", error);
                });
        });

        newSearch.addEventListener("keyup", () =>
            filterOptions(newSearch.value.toLowerCase())
        );
...
function clp_custom_select_ar_by_agency() {
    document.querySelectorAll(".multi_select_ar").forEach((select) => {
        ...
        // Clone display — removes stacked click listeners
        const oldDisplay = select.querySelector(".multi_display_ar");
        const newDisplay = oldDisplay.cloneNode(true);
        oldDisplay.parentNode.replaceChild(newDisplay, oldDisplay);
        // ✅ Get tagsBox from newDisplay, not detached oldDisplay
        const tagsBox = newDisplay.querySelector(".multi_tags_ar");
        tagsBox.innerHTML =
            '<span class="multi_placeholder_ar">Select type of CLP</span>';

        // Clone dropdown — removes stacked listeners
        const oldDropdown = select.querySelector(".multi_dropdown_ar");
        const newDropdown = oldDropdown.cloneNode(true);
        oldDropdown.parentNode.replaceChild(newDropdown, oldDropdown);
        const newSearch = newDropdown.querySelector(".multi_search_ar");
        const newOptionsList = newDropdown.querySelector(".multi_options_ar");
        ...
        newDropdown.addEventListener("click", (e) => e.stopPropagation());

        // ✅ Event delegation — works for dynamically added <li> items
        newOptionsList.addEventListener("click", (e) => {
            e.stopPropagation();
            const option = e.target.closest("li");
            if (!option) return;

            const val = option.dataset.value || option.getAttribute("value");
            const text = option.textContent;
        ...
        newSearch.addEventListener("keyup", () =>
            filter(newSearch.value.toLowerCase())
        );

        function filter(val) {
            newOptionsList.querySelectorAll("li").forEach((o) => {
                const oVal = o.dataset.value || o.getAttribute("value");
                if (values.includes(oVal)) {
                    o.style.display = "none";
                    return;
                }
                o.style.display = o.textContent.toLowerCase().includes(val)
        ...
        function updatePlaceholder() {
            const ph = tagsBox.querySelector(".multi_placeholder_ar");
            if (ph) ph.style.display = values.length ? "none" : "inline";
        }
    });
}
...
function closeChatWhenEventOccurs() {
    let chatBox1 = document.querySelector(".chatbot_layout_ar");
    chatBox1.classList.remove("slide_up");
    chatBox1.classList.add("fade_out");
    let chatBtn1 = document.querySelector(".chatbot_show_button_ar");

    setTimeout(() => {
        chatBox1.style.display = "none";
        chatBox1.classList.remove("fade_out");
        chatBtn1.style.display = "flex";
    }, 250);
    ...
    localStorage.removeItem("token");
    localStorage.removeItem("time");
    let ticketsTabOnClose1 = document.querySelector(
        '.tab_ar[data-tab="tickets_ar"]'
    );
    if (ticketsTabOnClose1) {
        document
            .querySelectorAll(".tab_ar")
            .forEach((t) => t.classList.remove("active_ar"));
        ticketsTabOnClose1.classList.add("active_ar");
        document
            .querySelectorAll(".tab_content_ar")
            .forEach((c) => c.classList.remove("active_ar", "fade_in"));
        const activeContent = document.getElementById("tab_tickets_ar");
        if (activeContent) activeContent.classList.add("active_ar", "fade_in");
    }
    clearFaqChat();
    clearLiveChat();
    ...
    if (phone_number_log_container_ar) {
        const phoneInput = phone_number_log_container_ar.querySelector(
            'input[name="phone"], input'
        );
        if (phoneInput) phoneInput.value = "";
    }
...
function reloadChatHistory() {
    ...
    const faqContainer = document.getElementById("faq_chat_ar");
    const liveContainer = document.getElementById("live_messages_ar");

    fetch(commonUrl + "api/all-conversation-by-phone", {
        method: "POST",
        ...
        .then((data) => {
            ...
            data.data.forEach((item) => {
                ...
                if (item.receive_status === 1) {
                    ...
                    if (item.conversation_type_id === 3) {
                ...
                if (item.receive_status === 2) {
                    ...
                    if (item.conversation_type_id === 3) {
                        ...
                        // FAQ / Product bot reply
                    } else {
                        const replyText =
                            item.reply && item.reply.reply
                                ? item.reply.reply
                                : item.message_body;
                        const file = item.reply && item.reply.file;
            ...
            // Re-attach Echo listener if session was Live-Chat
            const convType = localStorage.getItem("conversation_type");
            if (convType === "Live-Chat" && token) {
                chatbot_echo_listener(token);
            }
        })
        .catch((err) => console.error("Chat history reload failed:", err));
}
